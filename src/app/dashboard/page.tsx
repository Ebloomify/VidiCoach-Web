...
export default function DashboardPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
          <h3 className="text-lg font-medium text-gray-800 mb-2">暂无数据</h3>
          <p className="text-gray-600">请先上传一些视频内容</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* 页面标题 */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">培训系统 Dashboard</h1>
        <p className="text-gray-600">内容管理与运营效率监控</p>
      </div>

      {/* KPI 卡片 - 内容管理核心指标 */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">内容管理核心指标</h2>
        <KPICards stats={dashboardStats} />
      </div>

      {/* 图表区域 - 视频内容结构与分类 */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">视频内容结构与分类</h2>
        <ChartsSection stats={dashboardStats} />
      </div>

      {/* 最新动态与操作记录 */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">最新动态与操作记录</h2>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            ...
            待审核 ({dashboardStats.pendingPublishCount})
          </a>
          <a
          ...
          >
            ...
            已下架 ({dashboardStats.archivedCount})
          </a>
        </div>
      </div>
    </div>
